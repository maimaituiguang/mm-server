...
@app.route('/banner')
def banner():
    data = ['https://maimaituiguang.github.io/mm-web/images/banner8.png, https://maimaituiguang.github.io/mm-web/images/banner2.png, https://maimaituiguang.github.io/mm-web/images/banner1.png']
